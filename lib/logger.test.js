...
describe('log levels', () => {
  ...
  beforeAll(() => {
    // Import logger after mocking yargs
  ...
  beforeEach(() => {
     ...
     * atleast the winston logger in conjuction with Jest. Apperently this is
     * due to the custom Console Implementation as mentioned in the below
     * GitHub issue.
     * 
     * @ref https://github.com/jestjs/jest/issues/9984 
     */
